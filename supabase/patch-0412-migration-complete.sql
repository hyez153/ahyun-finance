-- 마이그레이션 영수증 완전 재입력 (소그룹+사역팀 포함)
-- patch-0412-migration-complete.sql
...
INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 18800, '2026-02-20', '심방', '식사 / 정연우, 김영광', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_01 정연우';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 18500, '2026-03-22', '소그룹 모임', '카페 / 정연우, 윤지훈 외 5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_01 정연우';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 24900, '2026-03-26', '심방', '식사 / 정연우, 윤지훈', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_01 정연우';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 27500, '2026-03-01', '소그룹_02 편라원', '심방_(카페) 편라원 외 6명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_02 편라원';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 21700, '2026-01-08', '심방', '식사 / 한유선, 편라훤 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 29700, '2026-01-08', '심방', '카페 / 한유선, 편라훤 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 15500, '2026-02-22', '소그룹 모임', '카페 / 한유선, 고성민 외 3명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 3500, '2026-02-22', '소그룹 모임', '카페 / 한유선, 고성민 외 3명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 40000, '2026-03-21', '소그룹 모임', '식사 / 한유선, 박서윤 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 29500, '2026-03-21', '소그룹 모임', '카페 / 한유선, 박서윤 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_03 한유선';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '이수민', id, 26000, '2026-01-11', '소그룹 모임', '소그룹모임(간식) / 이수민 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '이수민', id, 39600, '2026-01-18', '소그룹 모임', '소그룹모임(간식) / 이수민 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '이수민', id, 41700, '2026-02-26', '심방', '심방(식사) / 이수민 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 27500, '2026-03-15', '소그룹 모임', '소그룹모임(카페) / 이수민 외 6명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 28000, '2026-03-19', '심방', '심방(식사) / 이수민 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 27500, '2026-03-22', '심방', '심방(식사) / 이수민 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 30000, '2026-03-26', '심방', '심방(식사) / 이수민 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_04 이수민';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '박영규', id, 39000, '2026-01-11', '소그룹 모임', '카페 / 박영규, 김희주 외 5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '박영규', id, 49000, '2026-01-18', '소그룹 모임', '카페 / 박영규, 김희주 외 5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '박영규', id, 26200, '2026-02-12', '심방', '식사 / 박영규, 김희주', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '박영규', id, 18500, '2026-02-22', '소그룹 모임', '카페 / 박영규, 송인준 외 3명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '박영규', id, 19500, '2026-02-26', '심방', '식사 / 박영규, 조준서', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 30300, '2026-03-01', '심방', '식사 / 박영규, 김예원', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 11130, '2026-03-01', '소그룹 모임', '카페 / 박영규, 김희주 외 6명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 25500, '2026-03-01', '소그룹 모임', '카페 / 박영규, 김희주 외 6명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 30500, '2026-03-08', '소그룹 모임', '카페 / 박영규, 김희주 외 5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_05 박영규';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 12600, '2026-03-01', '소그룹_06 김영균', '소그룹 생일 케이크', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_06 김영균';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 16500, '2026-03-15', '소그룹 모임', '카페 / 김영균, 김준영 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_06 김영균';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '김요웅', id, 21000, '2026-01-18', '소그룹 모임', '카페_김요웅 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_07 김요웅';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 11500, '2026-02-22', '소그룹 모임', '카페 / 최예람, 김재혁 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_08 최예람';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 20000, '2026-03-20', '기타', '새가족 성경책 구매 선물', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_08 최예람';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 20000, '2026-03-29', '소그룹 모임', '카페 / 최예람, 김재혁 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_08 최예람';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 12500, '2026-01-18', '소그룹 모임', '카페 / 김수연, 장준호 외 2인', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_09 김수연';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 14500, '2026-01-18', '소그룹 모임', '카페 / 김은지, 김현지 외 3명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_10 김은지';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 19500, '2026-03-15', '소그룹 모임', '카페 / 김은지, 김현지 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_10 김은지';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 11500, '2026-01-18', '소그룹 모임', '카페 / 김경아, 김지환, 김준호', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_11 김경아';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 18000, '2026-02-22', '소그룹 모임', '카페 / 김경아, 김지환, 조형찬, 남상욱', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_11 김경아';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 3000, '2026-02-22', '소그룹 모임', '카페 / 김보람', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_11 김경아';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 16150, '2026-01-04', '소그룹 모임', '간식 / 김지원, 홍지은 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_13 김지원';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 14500, '2026-01-18', '소그룹 모임', '카페 / 김지원, 홍지은 외 2명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_13 김지원';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 17500, '2026-03-01', '소그룹 모임', '카페 / 김지원,김요섭 외 4명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_13 김지원';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 18500, '2026-02-22', '소그룹 모임', '카페 / 원수현, 이재경 외 3명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_14 원수현';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 17500, '2026-03-08', '소그룹 모임', '카페 / 원수현, 이재경 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '소그룹_14 원수현';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 10600, '2026-02-13', '심방', '카페 / 고성민, 박영규', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '카이노스 찬양팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 20000, '2026-02-14', '심방', '카페 / 고성민, 김희주 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '카이노스 찬양팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 26200, '2026-03-01', '심방', '카페 / 고성민, 김다슬 외 1명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '카이노스 찬양팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 167400, '2026-03-03', '물품구매', '단체티', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '카이노스 찬양팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 9270, '2026-03-12', '물품구매', '일회용 마이크커버', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '카이노스 찬양팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 71400, '2026-01-18', '소그룹 모임', '식사/윤지훈 외 5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '방송팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 81800, '2026-01-31', '소그룹 모임', '식사/윤지훈_외_7명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '방송팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 110000, '2026-03-27', '소그룹 모임', '모임/윤지훈_외_5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '방송팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 22000, '2026-03-28', '소그룹 모임', '모임/윤지훈_외_5명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '방송팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '김강영', id, 68500, '2026-03-07', '스포츠선교팀', '헤노테스 러닝 식사(라면) 김강영 외 17명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '스포츠선교팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 12400, '2026-03-14', '스포츠선교팀', '헤노테스 주차비', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '스포츠선교팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 66300, '2026-03-14', '스포츠선교팀', '헤노테스 러닝커피_손은혜 외 13명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '스포츠선교팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '김강영', id, 9700, '2026-03-14', '스포츠선교팀', '헤노테스 러닝커피_김강영 외1 명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '스포츠선교팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 53000, '2026-01-24', '소그룹 모임', '뉴플랜트 MT 식사 / 장준호, 최정환 외 8명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', NULL, id, 52000, '2026-01-24', '소그룹 모임', '뉴플랜트 MT 카페 / 장준호, 최정환 외 8명', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 9120, '2026-03-10', '물품구매', '뉴플랜트 / 03.21.토요 집회 초대장', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '임형재', id, 147090, '2026-03-20', '물품구매', '뉴플랜트 / 03.21.토요 집회 물품(다과)', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 80000, '2026-03-21', '소그룹 모임', '뉴플랜트 / 토요 집회 준비 식사(장준호 외 15명)', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 60000, '2026-03-25', '물품구매', '제천 사역 및 청소년 사역 감사 선물: 송인준, 박영규, 장세창', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 20000, '2026-03-25', '물품구매', '제천 사역 및 청소년 사역 감사 선물: 이시우', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 20000, '2026-03-25', '물품구매', '제천 사역 및 청소년 사역 감사 선물: 김예원', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '원수현', id, 10710, '2026-03-18', '물품구매', '뉴플랜트 / 03.21.토요 집회 물품(블랙보드마카)', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '전도팀';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '김지환', id, 60000, '2026-02-08', '물품구매', '기도노트 40권 구매', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '로뎀 기도회';

INSERT INTO public.receipts (submitter_name, payer_name, budget_category_id, amount, receipt_date, vendor_name, memo, file_url, file_path, status, is_claimed)
SELECT '마이그레이션', '임형재', id, 38000, '2026-02-20', '물품구매', '로뎀금요기도회 식사 비용', '실물영수증제출', 'migration', 'approved', true
FROM public.budget_categories WHERE category_name = '로뎀 기도회';

-- Total: 255 individual receipts