...
import { Receipt, CreditCard, BarChart3, AlertTriangle, FileSearch, FolderSearch, FileBarChart } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {[
          ...
          { href: '/admin/quarter-report', label: '분기 예산 집행 보고', desc: '분기별 집행률 · 항목별 A/B/C', icon: FileBarChart, color: 'purple' },
